#include "StdAfx.h"
#include "hgGroundWatchTimerHandler.h"
...
hgGroundWatchTimerHandler::hgGroundWatchTimerHandler(const std::string& name)
    : vtsTimerHandler(name)
{
}

hgGroundWatchTimerHandler::~hgGroundWatchTimerHandler(void)
{
    
}

vtsTimerHandler::WorkMode hgGroundWatchTimerHandler::workMode()
{
    return vtsTimerHandler::WorkMode_thread;
}

void hgGroundWatchTimerHandler::handle(const boost::system::error_code& e)
{
    //   CONGESTIONWATCH   æØ∏Ê¿‡–Õ
