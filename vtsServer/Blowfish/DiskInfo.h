...
public:
    ...
    std::vector<std::string> m_serialNumberVec;
...
public:
    ...
    const char* getSerialNumber(UINT drive);
...
private:
    ...
    void AddSerialNumber(USHORT *pIdSector);

};

extern void change_byte_order(char *szString, unsigned short uscStrSize);
